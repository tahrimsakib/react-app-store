        ...
        <div className="max-w-5xl w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <p className="text-purple-200 text-sm mb-4">Total Downloads</p>
              <h3 className="text-6xl font-bold text-white mb-2">29.6M</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-6xl font-bold text-white mb-2">906K</h3>
              <p className="text-purple-300 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="text-6xl font-bold text-white mb-2">132+</h3>
